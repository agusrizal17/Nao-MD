...
function connect(PORT) {
    ...
    <div>Bot: Online</div>
        ...
        <div class="container text-center">
            <a href="https://wa.me/6285869025919" class="btn btn-custom btn-primary" target="_blank">Use Bot</a>
        </div>
    <br>
        <div class="container text-center">
            <a href="https://pernikahankita.com/" class="btn btn-custom btn-primary" target="_blank">Visit My Website</a>
        </div>
